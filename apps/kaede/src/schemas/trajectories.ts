...
const startConstraintSchema = z
  ...
  .openapi('StartTrajectoryConstraint')

const waypointConstraintSchema = z
  .object({
    seq: z.number().int().min(0).openapi({
      description: 'constraint の並び順。0 始まりで欠番なく連続する整数',
    }),
  ...
  .openapi('WaypointTrajectoryConstraint')

const goalConstraintSchema = z
  .object({
    seq: z.number().int().min(0).openapi({
      description: 'constraint の並び順。0 始まりで欠番なく連続する整数',
    }),
  ...
  .openapi('GoalTrajectoryConstraint')

export const trajectoryConstraintSchema = z
  .discriminatedUnion('point_type', [
    startConstraintSchema,
    waypointConstraintSchema,
    goalConstraintSchema,
  ])
  .openapi('TrajectoryConstraint')
...
export const createTrajectoryRequestSchema = z
  ...
  .openapi('CreateTrajectoryRequest')

export const cloneAndReanalyzeRequestSchema = z
  .object({
    constraints: z
      .array(trajectoryConstraintSchema)
      .min(1)
  ...
  .openapi('CloneAndReanalyzeRequest')

export const trajectoryIdParamsSchema = z
  .object({
    trajectoryId: uuidSchema.openapi({
      description: 'trajectory を一意に識別する ID',
    }),
  })
  .openapi('TrajectoryIdParams')

export const createTrajectoryResponseSchema = z
  .object({
  ...
  .openapi('CreateTrajectoryResponse')
...
export const callbackErrorResponseSchema = z
  .object({
...
export const organizationTrajectoriesResponseSchema = z
  .object({
    trajectories: z
      .array(
        z.object({
  ...
  .openapi('OrganizationTrajectoriesResponse')

export const trajectoryResultResponseSchema = z
  .object({
    trajectory_id: uuidSchema.openapi({
  ...
  .openapi('TrajectoryResultResponse')
...
export const trajectoryMapDataResponseSchema = z
  ...
  .openapi('TrajectoryMapDataResponse')

export const batchTrajectoryMapDataRequestSchema = z
  .object({
    data_type: mapDataTypeSchema.openapi({
  ...
  .openapi('BatchTrajectoryMapDataRequest')

export const batchTrajectoryMapDataResponseSchema = z
  .object({
    floor_id: uuidSchema.openapi({
  ...
  .openapi('BatchTrajectoryMapDataResponse')

export const retriedTrajectoryResponseSchema = z
  .object({
  ...
  .openapi('RetriedTrajectoryResponse')

export const uploadUrlWithPathResponseSchema = z
  .object({
    trajectory_id: uuidSchema.openapi({
  ...
  .openapi('UploadUrlWithPathResponse')

export const trajectoryCompletionResponseSchema = z
  .object({
    trajectory_id: uuidSchema.openapi({
  ...
  .openapi('TrajectoryCompletionResponse')
