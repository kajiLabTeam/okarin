...
export const createFloorRequestSchema = z
  ...
  .openapi('CreateFloorRequest')

export const createFloorMultipartRequestSchema = z
  .object({
  ...
  .openapi('CreateFloorMultipartRequest')
